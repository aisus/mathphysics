...
%		 
%		 На рисунках 1-3 приведены графики зависимости концентрации раствора от пространственной переменной $x$ в момент времени $t = 75с$, полученные с помощью простейшей неявной схемы.
%	
%		 \begin{figure}[H]
%		  \begin{center}
...
%		\begin{table}[H]
%	\centering
%	\caption{ Погрешность простейшей неявной схемы }
...
\section*{Приложение А}
{
	...
	\textbf{Код программы}
	\end{center}
	\subsection*{A.1 Неявная схема}
	{
		\addcontentsline{toc}{subsection}{A.1 Неявная схема}
	%	\lstinputlisting[language=python,mathescape=false]{sources/main.py}
	}
	\newpage
	\subsection*{A.2 Схема Кранка-Николсона}
	{
		\addcontentsline{toc}{subsection}{A.2 Схема Кранка-Николсона}
	%	\lstinputlisting[language=python,mathescape=false]{sources/main_kr.py}
	}
