...
Результаты экспериментального исследования сходимости разностной схемы представлены в таблице 1:
	...
	\begin{tabularx}{0.9\textwidth}{|Y|Y|Y|Y|Y|Y|}
		...
		4 & 4 & 0.5 & 1.0 & 0.5120  & -  \\ \hline
		16 & 8 &  0.25 & 0.5 & 0.0770 & 6.65  \\ \hline
		64 & 16 & 0.0125 & 0.25 &   0.0540 & 1.43  \\ \hline
		256 & 32 & 0.0625 & 0.125 &   0.0211 & 2.55  \\ \hline
		1024 & 64 & 0.03125 & 0.0625 &   \num{8.65e-3} & 2.45  \\ \hline
		4096 & 128 & 0.015625 & 0.03125 &   \num{3.87e-3} & 2.23  \\ \hline
\end{tabularx}
	\label{tab1}
\end{table}
